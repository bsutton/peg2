...
class Parser {
  ...
  List<String> _parseTypeArguments(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        ...
        var $13 = _cp;
        var $14 = _pos;
        _parse_$Comma(167, false);
        if (_success) {
          var $16 = _parseType(168, $1);
          if (_success) {
            $11 = $16;
          } else {
            _c = $12;
  ...
  String _parse_non_terminal_name(int $0, bool $1) {
    ...
    var $6 = _cp;
    var $7 = _pos;
    var $8 = _parse$$IDENTIFIER(171, $1);
    if (_success) {
      _parse$$SPACING(172, false);
      if (_success) {
        $4 = $8;
      } else {
        _c = $5;
  ...
  String _parse_terminal_name(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        ...
        $1 = $30;
        if (_success) {
          _parse$$TERMINAL_CHAR(186, false);
          if (_success) {
            $22 = $32;
          } else {
            _c = $23;
  ...
  String _parse_type_name(int $0, bool $1) {
    ...
    var $6 = _cp;
    var $7 = _pos;
    var $8 = _parse$$IDENTIFIER(203, $1);
    if (_success) {
      _parse$$SPACING(204, false);
      if (_success) {
        $4 = $8;
      } else {
        _c = $5;
  ...
  String _parse_action(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        var $15 = _parse$$ACTION_BODY(216, $1);
        if (!_success) {
          _success = true;
          break;
        }
  ...
  String _parse_globals(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        var $15 = _parse$$GLOBALS_BODY(253, $1);
        if (!_success) {
          _success = true;
          break;
        }
  ...
  Expression _parse_literal(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        ...
        $1 = $19;
        if (_success) {
          var $22 = _parse$$LITERAL_CHAR(271, $1);
          if (_success) {
            $11 = $22;
          } else {
            _c = $12;
  ...
  String _parse_members(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        var $15 = _parse$$ACTION_BODY(281, $1);
        if (!_success) {
          _success = true;
          break;
        }
  ...
  dynamic _parse$$ACTION_BODY(int $0, bool $1) {
    ...
    for (;;) {
      ...
      if (_success) {
        ...
        for (;;) {
          var $10 = _parse$$ACTION_BODY(324, false);
          if (!_success) {
            _success = true;
            break;
          }
  ...
  String _parse$$IDENTIFIER(int $0, bool $1) {
    ...
    var $11 = _cp;
    var $12 = _pos;
    var $13 = _parse$$IDENT_START(365, $1);
    if (_success) {
      List<int> $14;
      if ($1) {
        $14 = [];
      ...
      for (;;) {
        var $15 = _parse$$IDENT_CONT(367, false);
        if (!_success) {
          _success = true;
          break;
        }
  ...
  int _parse$$IDENT_CONT(int $0, bool $1) {
    ...
    for (;;) {
      int $4;
      var $5 = _parse$$IDENT_START(370, $1);
      $4 = $5;
      if (_success) {
        $3 = $4;
        break;
  ...
  int _parse$$LITERAL_CHAR(int $0, bool $1) {
    ...
    for (;;) {
      ...
      int $11;
      var $12 = _parse$$HEX_NUMBER(381, $1);
      $11 = $12;
      if (_success) {
        $3 = $11;
        break;
  ...
  List<int> _parse$$RANGE(int $0, bool $1) {
    ...
    for (;;) {
      ...
      var $6 = _cp;
      var $7 = _pos;
      var $8 = _parse$$RANGE_CHAR(390, $1);
      if (_success) {
        _matchString('-');
        if (_success) {
          var $10 = _parse$$RANGE_CHAR(392, $1);
          if (_success) {
            var s = $8;
            var e = $10;
            List<int> $$;
      ...
      List<int> $11;
      var $12 = _parse$$RANGE_CHAR(394, $1);
      if (_success) {
        var c = $12;
        List<int> $$;
        $$ = [c, c];
  ...
  int _parse$$RANGE_CHAR(int $0, bool $1) {
    ...
    for (;;) {
      ...
      int $11;
      var $12 = _parse$$HEX_NUMBER(400, $1);
      $11 = $12;
      if (_success) {
        $3 = $11;
        break;
