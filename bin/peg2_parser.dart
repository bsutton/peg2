...
class Peg2Parser {
  ...
  String _parse_terminal_name(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        ...
        $1 = $28;
        if (_success) {
          _parse$$TERMINAL_CHAR(184, false);
          if (_success) {
            $20 = $30;
          } else {
            _c = $21;
  ...
  String _parse_type_name(int $0, bool $1) {
    ...
    var $6 = _cp;
    var $7 = _pos;
    var $8 = _parse$$IDENTIFIER(201, $1);
    if (_success) {
      _parse$$SPACING(202, false);
      if (_success) {
        $4 = $8;
      } else {
        _c = $5;
  ...
  String _parse_action(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        var $15 = _parse$$ACTION_BODY(214, $1);
        if (!_success) {
          _success = true;
          break;
        }
  ...
  String _parse_globals(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        var $15 = _parse$$GLOBALS_BODY(251, $1);
        if (!_success) {
          _success = true;
          break;
        }
  ...
  Expression _parse_literal(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        ...
        $1 = $19;
        if (_success) {
          var $22 = _parse$$LITERAL_CHAR(269, $1);
          if (_success) {
            $11 = $22;
          } else {
            _c = $12;
  ...
  String _parse_members(int $0, bool $1) {
    ...
    if (_success) {
      ...
      for (;;) {
        var $15 = _parse$$ACTION_BODY(279, $1);
        if (!_success) {
          _success = true;
          break;
        }
  ...
  dynamic _parse$$ACTION_BODY(int $0, bool $1) {
    ...
    for (;;) {
      ...
      if (_success) {
        ...
        for (;;) {
          var $10 = _parse$$ACTION_BODY(322, false);
          if (!_success) {
            _success = true;
            break;
          }
  ...
  String _parse$$IDENTIFIER(int $0, bool $1) {
    ...
    var $11 = _cp;
    var $12 = _pos;
    var $13 = _parse$$IDENT_START(363, $1);
    if (_success) {
      List<int> $14;
      if ($1) {
        $14 = [];
      ...
      for (;;) {
        var $15 = _parse$$IDENT_CONT(365, false);
        if (!_success) {
          _success = true;
          break;
        }
  ...
  int _parse$$IDENT_CONT(int $0, bool $1) {
    ...
    for (;;) {
      int $4;
      var $5 = _parse$$IDENT_START(368, $1);
      $4 = $5;
      if (_success) {
        $3 = $4;
        break;
  ...
  int _parse$$LITERAL_CHAR(int $0, bool $1) {
    ...
    for (;;) {
      ...
      int $11;
      var $12 = _parse$$HEX_NUMBER(379, $1);
      $11 = $12;
      if (_success) {
        $3 = $11;
        break;
  ...
  List<int> _parse$$RANGE(int $0, bool $1) {
    ...
    for (;;) {
      ...
      var $6 = _cp;
      var $7 = _pos;
      var $8 = _parse$$RANGE_CHAR(388, $1);
      if (_success) {
        _matchString('-');
        if (_success) {
          var $10 = _parse$$RANGE_CHAR(390, $1);
          if (_success) {
            var s = $8;
            var e = $10;
            List<int> $$;
      ...
      List<int> $11;
      var $12 = _parse$$RANGE_CHAR(392, $1);
      if (_success) {
        var c = $12;
        List<int> $$;
        $$ = [c, c];
  ...
  int _parse$$RANGE_CHAR(int $0, bool $1) {
    ...
    for (;;) {
      ...
      int $11;
      var $12 = _parse$$HEX_NUMBER(398, $1);
      $11 = $12;
      if (_success) {
        $3 = $11;
        break;
