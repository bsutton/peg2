...
class ExampleParser {
  ...
  num _parse_number(int $00, bool $01) {
    ...
    if (_success) {
      ...
      final $058 = _pos;
      final $060 = _c;
      const $066 = [69, 69, 101, 101];
      _matchRanges($066);
      if (_success) {
        const $068 = [43, 43, 45, 45];
        _matchRanges($068);
        var $072 = false;
        for (;;) {
          const $073 = [48, 57];
  ...
  int _parse$$unescaped(int $00, bool $01) {
    ...
    for (;;) {
      ...
      int $016;
      const $019 = [93, 1114111];
      final $020 = _matchRanges($019);
      if (_success) {
        $016 = $020;
        $02 = $016;
        break;
