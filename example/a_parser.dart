...
class AParser {
  ...
  List<String> _parseA(int $0, bool $1) {
    List<String> $2;
    final $3 = _pos;
    List<String> $6;
    final $9 = _parse_a(2, $1);
    if (_success) {
      $6 = $9;
    }
    $2 = $6;
  ...
  List<String> _parse_a(int $0, bool $1) {
    List<String> $2;
    final $3 = _pos;
    final $4 = _c;
    List<String> $7;
